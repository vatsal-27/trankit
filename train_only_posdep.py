...
trainer = trankit.TPipeline(
    ...
    'train_conllu_fpath': './dataset/hindi_train.dat', # annotations file in CONLLU format  for training
    'dev_conllu_fpath': './dataset/hindi_dev.dat', # annotations file in CONLLU format for development
    'max_epoch': 100}
)
...
test_set = TaggerDataset(
    ...
    input_conllu="./dataset/hindi_test.dat",
    gold_conllu="./dataset/hindi_test.dat",
    evaluate=True
)
test_set.numberize()
...
# test_set = TaggerDataset(
#     config=trainer._config,
#     input_conllu="./dataset/malayalam_test.dat",
#     gold_conllu="./dataset/malayalam_test.dat",
#     evaluate=True
# )
# test_set.numberize()
# test_batch_num = len(test_set) // trainer._config.batch_size + (len(test_set) % trainer._config.batch_size != 0)
